...
namespace WebAPI.Models.Context
{
    ...
    {
        public SecSoulContext()
        {
        }

        public SecSoulContext(DbContextOptions<SecSoulContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=LAPTOP-QKSJGFKM; Database=SecSoul; Trusted_Connection=True;");
            }
        }
